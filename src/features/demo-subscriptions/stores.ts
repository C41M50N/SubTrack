...
import { DemoSubscription } from "./types";
...
export const useDemoSubscriptions = create<State>()(
  persist((set, get) => ({
    ...
    addSubscription(sub) {
      set({ subscriptions: 
        [
          ...get().subscriptions, { ...sub, id: uuidv4() }
        ]
      })
    },
...
export const useSelectedDemoSubscriptions = create<UseSelectedDemoSubscriptionsState>()((set, get) => ({
  subscriptions: [],
