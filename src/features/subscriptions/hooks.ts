...
export function useSubscriptionsFromCollection(collectionId: string | null, enabled = true) {
...
export function useCreateSubscription() {
  ...
  const { mutateAsync: createSubscription, isLoading: isCreateSubscriptionLoading } =
...
export function useUpdateSubscription() {
  const utils = api.useUtils();
  const { mutateAsync: updateSubscription, isLoading: isUpdateSubscriptionLoading } =
...
export function useDeleteSubscription() {
  const utils = api.useUtils();
  const { mutateAsync: deleteSubscription, isLoading: isDeleteSubscriptionLoading } =
...
export function useMoveSubscription() {
  const utils = api.useUtils();
  const { mutateAsync: moveSubscription, isLoading: isMoveSubscriptionLoading } =
